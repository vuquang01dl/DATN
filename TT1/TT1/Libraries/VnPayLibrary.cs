    ...
    public class VnPayLibrary
    {
        ...
        public VnPayPaymentResponses GetFullResponseData(IQueryCollection collection, string hashSecret, Request_VNPayPayment request)
        {
            ...
            try
            {
                ...
                var ordStatus = _context.OrderStatus.FirstOrDefault(x => x.Id == order.order_statusId);
                message.Body = $"Đơn hàng {orderId} {ordStatus.status_name}";
