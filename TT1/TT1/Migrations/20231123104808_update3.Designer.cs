...
namespace TT1.Migrations
{
    ...
    [Migration("20231123104808_update3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Cart_item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Carts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("noteOder")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("order_statuId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Order_detail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Order_status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Cart_item", b =>
                {
                    b.HasOne("ThucTapW1.Entities.Carts", "carts")
                        .WithMany("cart_items")
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Order", b =>
                {
                    b.HasOne("ThucTapW1.Entities.Order_status", "order_status")
                        .WithMany("orders")
                        .HasForeignKey("order_statusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ThucTapW1.Entities.Payment", "payment")
                        .WithMany("orders")
            ...
            modelBuilder.Entity("ThucTapW1.Entities.Order_detail", b =>
                {
                    b.HasOne("ThucTapW1.Entities.Order", "order")
